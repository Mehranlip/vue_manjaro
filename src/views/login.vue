          ...
          <div >
            ...
            <div class="row">
              <div class="glass_box col-12 col-md-6  text-center p-5 " >
                <div class="mt-5">
                  <h1 class="mb-3" id="title-welcome">Welcome to Login</h1>
              ...
              <div class=" box-form col-12 col-md-6 p-5">
                ...
                <form>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="realmehranasadi@gamil.com">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="mt-3">
                    <span class="sg-signup">Dont have an account? <router-link to="signup">aJoin free today</router-link></span>
